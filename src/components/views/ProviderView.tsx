      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right text-white">
            <div className="text-lg font-bold bg-gradient-to-r from-yellow-400 via-green-400 to-blue-400 bg-clip-text text-transparent">Provider Dashboard</div>
          ...
          <div className="p-8">
            <div className="max-w-6xl mx-auto">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsTrigger value="earnings" className="text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-yellow-400 data-[state=active]:via-green-400 data-[state=active]:to-blue-400 data-[state=active]:text-white hover:bg-yellow-500/20 transition-all duration-200">
                  Earnings
                </TabsTrigger>
              </TabsList>
                ...
                <TabsContent value="dashboard" className="mt-6">
                  <div className="mb-8">
                    <h1 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 via-green-400 to-blue-400 bg-clip-text text-transparent mb-2">Welcome back, {currentProvider.name}!</h1>
